...
public class Forminputservice {
	...
	public void generate(Forminput f) {
		...
		System.out.println(f.getNompackage().toString());
		 String[] arrOfStr = newPackage.split(".");
...
//		String newPackagePath = pp;
//		//String newTestPackagePath = "com\\cdg\\business\\test\\";
//		String newTestPackagePath = pp+"test\\";
//		String NewProjectName = f.getNomprojet().toString();
//
//		String orginPathProjectMain = "C:\\Eclipse\\workspace\\" + f.getNomprojet().toString() + "\\src\\main\\java\\";
//
//		String orginPathProjectTest = "C:\\Eclipse\\workspace\\" + f.getNomprojet().toString() + "\\src\\test\\java\\";
//
...
//		String directory = "C:\\Eclipse\\workspace\\" + f.getNomprojet().toString() + "\\";
//		String host = "localhost:3306";
//		String driverName = "com.mysql.cj.jdbc.Driver";
//		String username = f.getNomutilisateur().toString();
//		String databaseName = f.getnombd().toString();
//		String password = f.getMotdepasseutilisateur().toString();
...
//
//		/////////////////////////////////////////////////////////////////////////////////////////////
//		EntitiesGenerator generator = new EntitiesGenerator(host, driverName, databaseName + "?serverTimezone=UTC",
...
//
//			List<String> result = walk.map(x -> x.toString()).filter(f -> f.endsWith(".java"))
